    ...
    */
    ...
    function add_member() {
        ...
        if($class && $query) {
            ...
            if(!$user) echo 'User not found!';
                ...
                echo 'Add member '.$user_name.'('.$user->ID.') to class '.$class->post_title;
            }
            
        } else echo 'Please enter username or email address!';
    ...
    function remove_member() {
        ...
        if($user && $class) {
            ...
            echo 'Remove user '.$user_name.' form class '.$class->post_title.' success';
        } else echo 'User or Class not found!';
        wp_die();
    }
